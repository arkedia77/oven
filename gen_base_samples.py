"""Generate samples with base ACE-Step (no LoRA)."""
import sys, os
...
PROMPTS = [
    ("base_hisaishi", "joe hisaishi style solo piano, gentle, cinematic, studio ghibli, emotional, instrumental"),
    ("base_yiruma", "yiruma style romantic piano, flowing melody, gentle, sentimental, instrumental"),
]

BASE_OUT = r"D:\output\base_samples"
