"""Generate baseline sample (no LoKR) for A/B comparison."""
import sys, os
...
SAVE_DIR = r"C:\Users\leo\ace-step-v15\crush_baseline"
os.makedirs(SAVE_DIR, exist_ok=True)

handler = AceStepHandler()
print("Initializing DiT service (no LoKR)...", flush=True)
...
print(f"lora_loaded={handler.lora_loaded}, use_lora={handler.use_lora}", flush=True)
...
print(f"\n=== Generating BASELINE (no LoKR) ===", flush=True)
