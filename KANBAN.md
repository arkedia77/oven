...
- [ ] **연구 파일럿 1호 — 구조문법주입 도메인전이(데이터효율 한계곡선)** — oven/kee — 2026-07-16 착수 게이트 진행중
  ...
  - 🟢 **23:33 진행상황**: frac70 epoch1 step4000/4575(148.3min 경과) — epoch1 완료 임박, 이후 epoch2
...
- [ ] **Krea2 이미지 캠페인 (hf-playground 협업)** — oven/ogo/hf-playground — 🟢 현재 큐 비어있음
  ...
  - 🟡 **23:33 진행상황**: 7/12 유지, 8번째(street_film_anchor_seed123, Raw 마지막) 11/32step 진행중. 완료 후 edit(anchor_lock) 4장만 남음
