...
- [ ] **연구 파일럿 1호 — 구조문법주입 도메인전이(데이터효율 한계곡선)** — oven/kee — 2026-07-16 착수 게이트 진행중
  ...
  - 🟢 **20:04 진행상황**: frac50 epoch1 완료(19:11, ckpt_frac50_epoch1 실물 확인) → epoch2 진행중(step232/3268, 120.6min 총경과). epoch2 완료 후 frac70 시작
...
- [ ] **Krea2 이미지 캠페인 (hf-playground 협업)** — oven/ogo/hf-playground — 🟢 현재 큐 비어있음
  ...
  - 🟡 **20:04 진행상황**: 5/12 완료(street_film_plain_seed42 108.5min 소요 확정) — 6번째(street_film_plain_seed123) 진행중. street_film Raw 3장 남음(anchor×2 포함, 각 ~1.8h) + edit 4장 — 전체 완주 밤늦게나 예상
