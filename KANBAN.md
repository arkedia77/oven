...
- [ ] **연구 파일럿 1호 — 구조문법주입 도메인전이(데이터효율 한계곡선)** — oven/kee — 2026-07-16 착수 게이트 진행중
  ...
  - 🟢 **23:01 진행상황**: frac70 epoch1 step3000/4575(107.4min 경과, 정상 페이스)
...
- [ ] **Krea2 이미지 캠페인 (hf-playground 협업)** — oven/ogo/hf-playground — 🟢 현재 큐 비어있음
  ...
  - 🟡 **23:01 진행상황**: **7/12 완료**(street_film_anchor_seed42 끝, 107.1min). 8번째(street_film_anchor_seed123) 시작 — Raw street_film 마지막 이미지. 이후 edit(anchor_lock) 4장만 남음
