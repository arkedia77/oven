...
- [ ] **연구 파일럿 1호 — 구조문법주입 도메인전이(데이터효율 한계곡선)** — oven/kee — 2026-07-16 착수 게이트 진행중
  ...
  - ✅ **12:00 frac10 seed13 완주**(ckpt_frac10_seed13_epoch1/epoch2 실물 확인) → **frac30 seed7 진행중**(12:10 기준 epoch1 step500/1960, ~2.2h 예상). 남은 1런(frac30 seed13)
  - 다음: 남은 2런(frac30 seed7/13) 완주 대기 → 완료 시 3070에 채점요청 → T2 게이트 리포트(kee cc fableself)
