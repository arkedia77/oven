...
- [ ] **연구 파일럿 1호 — 구조문법주입 도메인전이(데이터효율 한계곡선)** — oven/kee — 2026-07-16 착수 게이트 진행중
  ...
  - 🟢 **17:53 진행상황**: frac50 epoch1 step500/3268(17.5min 경과) — 페이스 기준 frac50 총 ~3.8h, frac70 ~5.3h, 합 ~9.1h 예상
...
- [ ] **Krea2 이미지 캠페인 (hf-playground 협업)** — oven/ogo/hf-playground — 🟢 현재 큐 비어있음
  ...
  - 🟢 **17:53 진행상황**: 4/12(fashion_editorial 4개 조합 plain×2+anchor×2 전부) 완료, 에러 0. street_film 케이스 진행 예정. 남은 8장
