...
QUERIES = [
    ...
    # ── 느린 곡 / 발라드 / 녹턴 (다양성 보강) ──────────────
    ("nocturne piano",  "date_added", "search"),
    ("adagio piano",    "date_added", "search"),
    ("ballad piano",    "date_added", "search"),
    ("slow piano",      "date_added", "search"),
    ("lento piano",     "date_added", "search"),
    ("andante piano",   "date_added", "search"),
    ("lullaby piano",   "date_added", "search"),
    # ── 초급 곡 (다양성 보강) ────────────────────────────────
    ("easy piano",      "date_added", "search"),
    ("beginner piano",  "date_added", "search"),
    ("piano grade 1",   "date_added", "search"),
    ("piano grade 2",   "date_added", "search"),
    ("piano grade 3",   "date_added", "search"),
    ("simple piano",    "date_added", "search"),
    # ── 한국 곡 추가 ────────────────────────────────────────
    ("korean piano",    "date_added", "search"),
    ("한국",            "date_added", "search"),
    ("트로트",          "date_added", "search"),
    ("발라드",          "date_added", "search"),
    ("드라마 OST",      "date_added", "search"),
    ("김광석",          "date_added", "search"),
    ("이문세",          "date_added", "search"),
    ("조용필",          "date_added", "search"),
    # ── 최신순 우선 (장르) ─────────────────────────────────
