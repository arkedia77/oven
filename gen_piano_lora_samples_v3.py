"""Generate v3 comparison samples: 4 checkpoints × 6 prompts (reuse v2 base)."""
import sys, os
...
BASE_OUT = r"D:\output\piano-lora-v3\samples"
CKPT_ROOT = r"D:\output\piano-lora-v3\checkpoints"

VARIANTS = [
    ("ep20", os.path.join(CKPT_ROOT, "epoch_20_loss_0.5685")),
    ("ep40", os.path.join(CKPT_ROOT, "epoch_40_loss_0.5489")),
    ("ep60", os.path.join(CKPT_ROOT, "epoch_60_loss_0.5401")),
    ("ep80", r"D:\output\piano-lora-v3\final"),
]
