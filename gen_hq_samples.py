"""Generate high-quality base samples with audio quality prompts."""
import sys, os
...
PROMPTS = [
    ("hq_hisaishi", "joe hisaishi style solo grand piano, gentle, cinematic, studio ghibli, emotional, instrumental, studio recording, high fidelity, 48kHz, crystal clear sound"),
    ("hq_yiruma", "yiruma style romantic grand piano, flowing melody, gentle, sentimental, instrumental, studio quality, high fidelity, warm tone, professional recording"),
    ("hq_sakamoto", "ryuichi sakamoto style grand piano, ambient, contemplative, sparse, modern classical, instrumental, pristine audio quality, studio recording, hi-fi"),
]

BASE_OUT = r"D:\output\hq_samples"
