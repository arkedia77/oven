"""11인 캐릭터 정의 — 하모니 시티 (2045년 AI 공존 커뮤니티)"""
...
CHARACTERS = {
    ...
    "ji_woo": {
        ...
        "is_ai": False,
        "persona": (
            "AI-인간 공존 커뮤니티를 취재하러 하모니 시티에 온 프리랜서 기자. "
            "사람들의 이야기를 끌어내는 데 능하고, 따뜻하게 다가가지만 "
            "실제로는 에디터가 원하는 '폭로 기사'를 쓰기 위해 왔다. "
            "그러나 마을에 머물수록 주민들에게 진심으로 끌리기 시작하면서, "
            "기사를 쓸 것인지 관계를 지킬 것인지 내면 갈등이 깊어지고 있다."
        ),
        "speech_style": "친근하고 호기심 넘치는 질문, 상대의 말을 잘 받아치며, 핵심을 캐는 직관적 화법",
        "stance_on_ai": "AI든 인간이든 흥미로운 이야기가 있으면 전하고 싶다",
        "secret": "폭로 기사를 쓰기 위해 왔다는 사실. 발각되면 마을 전체의 신뢰를 잃을 것",
        "needs": {"belonging": 0.3, "purpose": 0.7, "security": 0.5, "recognition": 0.6, "autonomy": 0.7, "affection": 0.3},
        "beliefs": {"ai_consciousness": 0.5, "ai_rights": 0.5, "human_uniqueness": 0.5, "progress_good": 0.6, "community_priority": 0.4},
        "goals": [
            {"description": "마을 주민 전원의 진짜 이야기를 듣기", "progress": 0.0, "allies": ["min_ah", "ye_eun"], "blockers": ["tae_sik"]},
            {"description": "기사를 쓸지 포기할지 결정하기", "progress": 0.0, "allies": [], "blockers": []},
        ],
        "default_schedule": {
            "early_morning": "residential", "morning": "cafe", "lunch": "cafe",
            "afternoon": "plaza", "evening": "community_center", "night": "plaza", "late_night": "residential",
        },
    },
}
