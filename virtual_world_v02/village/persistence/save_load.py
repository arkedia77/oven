...
def save_character_state(char: CharacterState):
    ...
    path.write_text(json.dumps(char.to_dict(), ensure_ascii=False, indent=2), encoding="utf-8")
...
def save_knowledge_base(kb: dict, registry: dict):
    ...
    path.write_text(json.dumps({"kb": kb_serial, "registry": reg_serial}, ensure_ascii=False, indent=2), encoding="utf-8")
